...
>(
  (
    { isMobile, loading, page, totalPages, itemsPerPage, onFilter, hasMore },
    ref
  ) => {
    const searchParams = useSearchParams();

    const handlePageSubmit = (newPage: any) => (e: any) => {
      e.preventDefault();
        ...
        {!isMobile && (
          <div className="flex items-center justify-between px-2 py-4 mt-4">
            ...
            >
              ...
              >
                <ArrowLeft color="white" className="w-4 h-4" />
              </Button>
              <span className="font-bold text-sm black-300 md:block hidden">
                Previous
              </span>
            </form>
            ...
            >
              ...
              >
                <ArrowRightIcon color="white" className="w-8 h-8" />
              </Button>
            </form>
          </div>
        )}
