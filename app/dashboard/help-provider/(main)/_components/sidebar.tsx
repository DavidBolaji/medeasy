...
const items: MenuItem[] = [
  getItem('Personal Details', '/dashboard/help-provider/personal-details'),
  getItem('Services Offered', '/dashboard/help-provider/services-offered'),
  getItem('Work Experience', '/dashboard/help-provider/work-experience'),
  getItem('ID Verification', '/dashboard/help-provider/id-verification'),
  getItem('Payment Details', '/dashboard/help-provider/payment-details'),
  // getItem('Account Manager', '/dashboard/help-provider/account-manager'),
];
